...
export const SAMPLE_PUBKEY_RS256 = `-----BEGIN PUBLIC KEY-----
...
MwIDAQAB
-----END PUBLIC KEY-----`;
export const SAMPLE_PRIVATEKEY_RS256 = `-----BEGIN PRIVATE KEY-----
...
export const SAMPLE_PRIVATEKEY_RS256_2 = `-----BEGIN PRIVATE KEY-----
